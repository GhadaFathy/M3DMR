...
#parser.add_argument("--test_file_list", type=str, default='/Users/Ghada/PHD/outputDepth/test_files_eigen.txt', help="Path to the list of test files")
...
parser.add_argument("--test_file_list", type=str, default='/Users/Ghada/PHD/for-eval/test/test_files_eigen.txt', 
...
def main():
    ...
    for i in range(num_test):    
        ...
        value=metrics.average_precision_score(gt_depth, pred_depth)
        print('value',value)
