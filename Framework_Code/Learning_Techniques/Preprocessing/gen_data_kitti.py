...
HEIGHT = 128
STEPSIZE = 1
INPUT_DIR = '/Users/Ghada/estimate_depth/new_Mask/Mask_RCNN-master/subdataset/2011_09_26_drive_0001_sync'
OUTPUT_DIR = '/Users/Ghada/estimate_depth/new_Mask/Mask_RCNN-master/Mask/KITTI_procesed'
...
for d in glob.glob(INPUT_DIR + '/*/'):
    ...
    for d2 in glob.glob(d + '*/'):
        ...
        for subfolder in ['image_03/data/']:
            ...
            calib_camera = calib_raw[0] if subfolder=='image_03' else calib_raw[1]
            folder = d2 
            print("folder = ", folder)
