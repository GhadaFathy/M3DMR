...
def inverse_warp(img, depth, egomotion_mat, intrinsic_mat,
  ...
  print('source_pixel_coords= ',source_pixel_coords.shape)                                   
